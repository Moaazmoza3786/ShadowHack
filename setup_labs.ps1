# ShadowHack CTF Lab Structure Generator (PowerShell Version)
# This script sets up the 5 levels of CTF challenges with Dockerfiles, Source Code, and Metadata.

Write-Host "🚀 Generating ShadowHack CTF Lab Structure..." -ForegroundColor Cyan

function Create-LabFile {
    param($Path, $Content)
    $Dir = Split-Path $Path
...
Create-LabFile "labs/level1/intern-mistake/Dockerfile" @"
FROM nginx:alpine
COPY index.html /usr/share/nginx/html/index.html
EXPOSE 80
"@

Create-LabFile "labs/level1/intern-mistake/index.html" @"
<!DOCTYPE html>
<html>
...
Create-LabFile "labs/level1/intern-mistake/metadata.json" @"
{
...
Create-LabFile "labs/level1/leaky-bucket/Dockerfile" @"
FROM php:7.4-apache
...
Create-LabFile "labs/level1/leaky-bucket/index.php" @"
<?php
...
Create-LabFile "labs/level1/leaky-bucket/dev_backups/flag.txt" "AG{unsecure_backups_lead_to_leaks_2024}"

Create-LabFile "labs/level1/leaky-bucket/metadata.json" @"
{
  "id": "ctf-leaky-bucket",
...
# 2.1 Login Limbo
Create-LabFile "labs/level2/login-limbo/Dockerfile" @"
FROM php:7.4-apache
...
Create-LabFile "labs/level2/login-limbo/index.php" @"
<?php
...
Create-LabFile "labs/level2/login-limbo/metadata.json" @"
{
  "id": "ctf-login-limbo",
  "name": "Login Limbo",
...
Create-LabFile "labs/level2/ghost-archive/Dockerfile" @"
FROM php:7.4-apache
...
Create-LabFile "labs/level2/ghost-archive/src/index.php" @"
<?php
...
Create-LabFile "labs/level2/ghost-archive/src/welcome.txt" "Welcome to the Ghost Archive."
Create-LabFile "labs/level2/ghost-archive/src/policy.txt" "Our policy is strictly digital."
Create-LabFile "labs/level2/ghost-archive/src/credits.txt" "Built by the Ancients."

Create-LabFile "labs/level2/ghost-archive/metadata.json" @"
{
...
# Level 3: Orbit
Create-LabFile "labs/level3/ping-pong/Dockerfile" @"
...
Create-LabFile "labs/level3/ping-pong/app.py" @"
import os
...
Create-LabFile "labs/level3/ping-pong/metadata.json" @"
{
  "id": "ctf-ping-pong",
  "name": "Ping Pong",
...
# Level 4: Deep Space
Create-LabFile "labs/level4/identity-paradox/Dockerfile" @"
FROM node:14-alpine
WORKDIR /app
COPY package.json .
...
Create-LabFile "labs/level4/identity-paradox/package.json" @"
{
...
Create-LabFile "labs/level4/identity-paradox/server.js" @"
...
Create-LabFile "labs/level4/identity-paradox/metadata.json" @"
{
...
# Level 5: Singularity
Create-LabFile "labs/level5/dark-matter-object/Dockerfile" @"
FROM python:3.9-slim
WORKDIR /app
RUN pip install flask
COPY app.py .
...
Create-LabFile "labs/level5/dark-matter-object/app.py" @"
...
Create-LabFile "labs/level5/dark-matter-object/metadata.json" @"
{
...
Write-Host "✅ Lab structure successfully generated in /labs folder!" -ForegroundColor Green
