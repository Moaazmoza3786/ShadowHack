        ...
        <div className="w-full md:w-64 space-y-2">
          {tabs.map((tab) => (
            <button
              ...
              className={`w-full flex items-center gap-4 px-6 py-4 rounded-2xl transition-all uppercase tracking-widest text-[10px] font-black border-2 ${
                activeTab === tab.id
        ...
        <div className="flex-1 bg-dark-800/50 border border-white/5 rounded-[2.5rem] p-10 space-y-10 relative overflow-hidden backdrop-blur-xl">
          ...
          {activeTab === "profile" && (
            <div className="space-y-8 animate-fade-in">
              <h2 className="text-3xl font-black uppercase italic tracking-tighter text-white/90">
                Operative Identity
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input
                    type="text"
                    className="w-full bg-black/40 border-2 border-white/5 rounded-2xl px-6 py-4 text-white focus:border-primary-500/50 outline-none transition-all font-mono"
                ...
                <div className="grid grid-cols-3 gap-4">
                  {["groq", "openai", "local"].map((provider) => (
                    <button
                      ...
                      className={`px-4 py-3 rounded-xl border border-white/10 text-xs font-bold uppercase tracking-wider transition-all ${
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setConfig({ ...config, SHODAN_API_KEY: e.target.value })
                    }
                    className="w-full bg-black/40 border-2 border-white/5 rounded-2xl px-6 py-4 text-white focus:border-primary-500/50 outline-none transition-all font-mono text-sm"
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setConfig({ ...config, OLLAMA_URL: e.target.value })
                    }
                    className="w-full bg-black/40 border-2 border-white/5 rounded-2xl px-6 py-4 text-white focus:border-primary-500/50 outline-none transition-all font-mono text-sm"
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="space-y-6">
                <button className="w-full flex items-center justify-between p-6 bg-white/5 border border-white/5 rounded-2xl hover:border-primary-500/30 transition-all group">
                  ...
                  <div className="text-primary-500 text-[10px] font-black uppercase tracking-widest">
                    Enable
                  </div>
                </button>
                <button className="w-full flex items-center justify-between p-6 bg-white/5 border border-white/5 rounded-2xl hover:border-primary-500/30 transition-all group">
